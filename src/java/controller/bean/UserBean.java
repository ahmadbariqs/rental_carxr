...
{  
    ...
    {  
        ...
        userDao.add(newuser);  
        System.out.println("User successfully saved. Check the email for more information.");  
        FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Save Information", "User successfully saved. Check the email for more information.");  
